...
function Total_Soft_Poll_1_Ans_Fix_Close(overlay,el){overlay.style.height=0;jQuery("."+el).css("width","0")}
function Total_Soft_Poll_1_Ans_Fix_Close2(el,overlay){el.style.width=0;jQuery("."+overlay).css("height","0")}
...
function Total_Soft_Poll_1_Ans_Lab(Total_Soft_Poll_1_Ans_ID,Poll_ID,event){var voteOnce=jQuery("#TotalSoft_Poll_3_Vote").val()
